...
# -*- coding: utf-8 -*-
"""
XML Fatura Otomasyonu — Aktivasyon Ekranı (PySide6)
...
class ActivationWindow(QDialog):
    def __init__(self, expired=False, expire_msg='', parent=None):
        ...
        self.setWindowTitle('XML Fatura Otomasyonu — Lisans Aktivasyonu')
    ...
    def _build(self):
        ...
        # ── Deneme butonu (süresi dolduysa gizle) ────────────────────────
        if not self.expired:
            ...
            trial_info = QLabel('30 gün  •  Toplam 5000 dosya  •  Ücretsiz')
    ...
    def _open_whatsapp(self):
        msg   = (f'Merhaba, XML Fatura Otomasyonu lisans talebim. '
