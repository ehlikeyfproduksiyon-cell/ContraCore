...
# -*- coding: utf-8 -*-
"""
ContraCore — XML Fatura Modül Adaptörü (cc_modules statik versiyon)
...
def _install_context():
    ...
    'from main import ...' cagrilarini cc_modules paketine yonlendirir.
    Inline import olduklari icin widget olusturulmadan once cagrilmasi yeterli.
    """
    from core.license import manager, trial
    from cc_modules.xml_fatura import activation as _activation
    from cc_modules.xml_fatura import main as _main
...
def _build_host(expire, trial_status):
    ...
    from cc_modules.xml_fatura import gui as _gui
